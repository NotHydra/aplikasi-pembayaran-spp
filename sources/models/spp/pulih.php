                      ...
                      $inputArray = [
                        [
                          ...
                          "value" => [
                            ...
                            }, mysqli_fetch_all(mysqli_query($connection, "SELECT DISTINCT YEAR(dibuat) FROM spp WHERE dihapus='1' ORDER BY dibuat DESC;")))), isset($_POST["tahun"]) ? $_POST["tahun"] : null
                          ],
                    ...
                    <div class="col-sm">
                      <table id="main-table" class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                          ...
                          $result = mysqli_query($connection, "SELECT id, tahun, nominal, dibuat, diubah FROM spp WHERE dihapus='1' $extraFilter ORDER BY dibuat DESC;");

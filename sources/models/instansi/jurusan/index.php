            ...
            [
              ...
              "child" => [
                [
                  ...
                  "title" => "Total Jurusan",
                  "icon" => "wrench",
                  "value" => mysqli_fetch_assoc(mysqli_query($connection, "SELECT COUNT(id) AS `total` FROM jurusan;"))["total"]
                ]
              ]
            ]
          ];
                      ...
                      $inputArray = [
                        [
                          ...
                          "value" => [
                            ...
                            }, mysqli_fetch_all(mysqli_query($connection, "SELECT DISTINCT YEAR(dibuat) FROM jurusan ORDER BY dibuat DESC;")))), isset($_POST["tahun"]) ? $_POST["tahun"] : null
                          ],

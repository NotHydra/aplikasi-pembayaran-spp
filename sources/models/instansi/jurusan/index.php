...
activity("Mengunjungi halaman jurusan");
            ...
            [
              ...
              "child" => [
                [
                  ...
                  "title" => "Total Jurusan",
                  "icon" => "wrench",
                  "value" => mysqli_fetch_assoc(mysqli_query($connection, "SELECT COUNT(id) AS `total` FROM jurusan WHERE dihapus='0';"))["total"]
                ]
              ]
            ]
          ];
                      ...
                      $inputArray = [
                        [
                          ...
                          "value" => [
                            ...
                            }, mysqli_fetch_all(mysqli_query($connection, "SELECT DISTINCT YEAR(dibuat) FROM jurusan WHERE dihapus='0' ORDER BY dibuat DESC;")))), isset($_POST["tahun"]) ? $_POST["tahun"] : null
                          ],
                    ...
                    <div class="col-sm">
                      <table id="main-table" class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                          ...
                          $result = mysqli_query($connection, "SELECT id, jurusan, singkatan, dibuat, diubah FROM jurusan WHERE dihapus='0' $extraFilter ORDER BY dibuat DESC;");

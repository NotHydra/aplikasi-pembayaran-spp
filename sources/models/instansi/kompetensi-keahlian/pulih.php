...
activity("Mengunjungi halaman pulih kompetensi keahlian");
...
<body class="hold-transition layout-navbar-fixed layout-fixed" id="body-theme">
                      ...
                      $inputArray = [
                        [
                          ...
                          "value" => [
                            ...
                            }, mysqli_fetch_all(mysqli_query($connection, "SELECT DISTINCT YEAR(dibuat) FROM kompetensi_keahlian WHERE dihapus='1' ORDER BY dibuat DESC;")))), isset($_POST["tahun"]) ? $_POST["tahun"] : null
                          ],
                      ...
                      <table id="main-table" class="table table-bordered table-striped table-sm">
                        <thead>
                          <tr>
                            ...
                            <th class="text-center align-middle export">Singkatan</th>
                        ...
                        <tbody>
                          ...
                          $result = mysqli_query($connection, "SELECT id, kompetensi_keahlian, singkatan, dibuat, diubah FROM kompetensi_keahlian WHERE dihapus='1' $extraFilter ORDER BY dibuat DESC;");
                          ...
                          ?>
                            <tr>
                              ...
                              <td class="text-center align-middle"><?php echo $data["singkatan"]; ?></td>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "GET") {
    if (isset($_GET["id"])) {
      try {
        $id = $_GET["id"];
        $result = mysqli_query($connection, "UPDATE kompetensi_keahlian SET dihapus='0' WHERE id='$id' AND dihapus='1';");

        if ($result) {
          activity("Memulihkan kompetensi keahlian");

                        ...
                        $inputArray = [
                          [
                            ...
                            "value" => [
                              ...
                              }, mysqli_fetch_all(mysqli_query($connection, "SELECT DISTINCT YEAR(dibuat) FROM kompetensi_keahlian ORDER BY dibuat DESC;")))), isset($_POST["tahun"]) ? $_POST["tahun"] : 0
                            ],
                    ...
                    <div class="col-sm">
                      <table id="main-table" class="table table-bordered table-striped table-sm">
                        ...
                        <tbody>
                          ...
                          $result = mysqli_query($connection, "SELECT id, kompetensi_keahlian, singkatan, dibuat, diubah FROM kompetensi_keahlian WHERE '1'='1' $extraFilter ORDER BY kompetensi_keahlian ASC;");

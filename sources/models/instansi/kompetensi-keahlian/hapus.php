...
activity("Mengunjungi halaman hapus kompetensi keahlian");
...
<body class="hold-transition layout-navbar-fixed layout-fixed" id="body-theme">
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    try {
      $result = mysqli_query($connection, "DELETE FROM kompetensi_keahlian WHERE id='$id';");

      if ($result) {
        activity("Menghapus kompetensi keahlian");
